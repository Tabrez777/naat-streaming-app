...
// 1. Accept the onClose prop here
const Sidebar = ({ isOpen, onClose }) => {
  // State to hold user-created playlists
  ...
  return (
    <aside className={`w-64 h-screen bg-black text-white flex flex-col pt-3 pb-6 px-4 select-none border-r border-neutral-900 fixed md:static top-0 left-0 z-50 transition-transform duration-300 ease-in-out ${
      isOpen ? 'translate-x-0' : '-translate-x-full md:translate-x-0'
    }`}>
      
      {/* 2. ❌ BRAND HEADER: Only visible on mobile (md:hidden) to match your screenshot */}
